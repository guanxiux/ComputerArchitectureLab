...
HD_PWD='C:/Users/wo/OneDrive - mail.ustc.edu.cn/ComputerStructure/ComputerArchitectureLab/1_VerilogSourceCode/RISC-V-MulticycleCPU/RISC-V-MulticycleCPU.runs/synth_1'
cd "$HD_PWD"
